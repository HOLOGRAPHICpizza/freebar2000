package org.peak15.freebar2000.musicbrowser;
...
import org.peak15.freebar2000.common.DefaultMusic;
...
public final class MusicBrowserTopComponent extends TopComponent implements ExplorerManager.Provider {
	...
	public MusicBrowserTopComponent() {
		...
		vavaList.add(new DefaultMusic("What"));
		vavaList.add(new DefaultMusic("Empathy"));
		
		List<Music> bassList = new ArrayList<Music>();
		bassList.add(new DefaultMusic("VAVA VOOM", vavaList));
		bassList.add(new DefaultMusic("MOTW"));
		
		List<Music> all = new ArrayList<Music>();
		all.add(new DefaultMusic("Bassnectar", bassList));
		all.add(new DefaultMusic("Human"));
		
		library = new DefaultMusic("All Music", all);
